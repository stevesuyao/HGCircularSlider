//
//  SmartRangeCircularProgressBar.swift
//  HGCircularSlider
//
//  Created by Steve Yao on 12/1/22.
 ...
 */
@IBDesignable
open class SmartRangeCircularProgressBar: UIControl {
     ...
     */
    @IBInspectable
    open var secondTrackRadiusOffset: CGFloat = 0.0
    
    /**
     *
     */
    @IBInspectable
    open var thirdTrackRadiusOffset: CGFloat = 0.0
     ...
     */
    @IBInspectable
    open var secondTracklineWidth: CGFloat = 5.0
     ...
     */
    @IBInspectable
    open var thirdTrackLineWidth: CGFloat = 5.0
     ...
     */
    @IBInspectable
    open var sliderEndAngleFactor: CGFloat = 1.0
     ...
     */
    @IBInspectable
    open var fillTrackStartingFactor: CGFloat = 0.0
    ...
    */
    @IBInspectable
    open var enableThridTrack: Bool = false
    ...
    override open func draw(_ rect: CGRect) {
        ...
        let endAngle = CircularSliderHelper.scaleToAngle(value: endPointValue, inInterval: valuesInterval) + fillTrackStartingFactor * CircularSliderHelper.pi
...
extension SmartRangeCircularProgressBar {
     ...
     */
    internal static func drawArc(withArc arc: Arc, lineWidth: CGFloat = 2, mode: CGPathDrawingMode = .fillStroke, inContext context: CGContext, squareLineCap: Bool = true) {
    ...
    internal func drawCircularSlider(inContext context: CGContext) {
        ...
        let circle = Circle(origin: bounds.center, radius: self.radius - secondTrackRadiusOffset)
        ...
        SmartRangeCircularProgressBar.drawArc(withArc: sliderArc, lineWidth: backtrackLineWidth, inContext: context, squareLineCap: !enableRoundLineCap)
    }
    ...
    internal func drawFilledArc(fromAngle startAngle: CGFloat, toAngle endAngle: CGFloat, inContext context: CGContext) {
        ...
        // fill Arc
        SmartRangeCircularProgressBar.drawDisk(withArc: arc, inContext: context)
        // stroke Arc
        SmartRangeCircularProgressBar.drawArc(withArc: arc, lineWidth: lineWidth, mode: .stroke, inContext: context, squareLineCap: !enableFirstTrackRoundLineCap)
    }
    
    /// draw the 2nd Filled arc between start an end angles
    internal func drawSecondFilledArc(fromAngle startAngle: CGFloat, toAngle endAngle: CGFloat, fillColor strokeColor: UIColor, inContext context: CGContext) {
        ...
        // stroke Arc
        SmartRangeCircularProgressBar.drawArc(withArc: arc, lineWidth: secondTracklineWidth, mode: .stroke, inContext: context, squareLineCap: !enableSecondTrackRoundLineCap)
    }
    ...
    internal func drawThirdFilledArc(fromAngle startAngle: CGFloat, toAngle endAngle: CGFloat, fillColor strokeColor: UIColor, inContext context: CGContext) {
        ...
        // stroke Arc
        SmartRangeCircularProgressBar.drawArc(withArc: arc, lineWidth: thirdTrackLineWidth, mode: .stroke, inContext: context, squareLineCap: !enableSecondTrackRoundLineCap)
    }
    ...
    internal func drawShadowArc(fromAngle startAngle: CGFloat, toAngle endAngle: CGFloat, inContext context: CGContext) {
        ...
        // stroke Arc
        SmartRangeCircularProgressBar.drawArc(withArc: arc, lineWidth: lineWidth, mode: .stroke, inContext: context)
    }
    ...
    internal func drawThumbAt(_ angle: CGFloat, with image: UIImage? = nil, inContext context: CGContext) -> CGPoint {
        ...
        SmartRangeCircularProgressBar.drawArc(withArc: thumbArc, lineWidth: thumbLineWidth, inContext: context)
        return thumbOrigin
    }
